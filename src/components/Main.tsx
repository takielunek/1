...
const Main = () => {
  return (
    <div className="wrapper px-[10px] pt-[20px] pb-[30px] ss:py-[40px] sm:py-[80px]">
        ...
        <div className="w-4/5 sm:w-1/2 grid place-items-center">
          <div className="flex-column">
            ...
            <p className="text-xl">
              ...
              skillset or a beginner eager to dive into a new field, our diverse
              range of courses caters to all levels of experience and ambition.
            </p>
          </div>
        </div>
